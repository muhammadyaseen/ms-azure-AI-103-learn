###
# Exercise: https://microsoftlearning.github.io/mslearn-ai-agents/Instructions/Exercises/08-agent-framework-multi-agents.html

# In this exercise, you’ll practice using the sequential orchestration pattern in the 
# Microsoft Agent Framework SDK. You’ll create a simple pipeline of three agents that 
# work together to process customer feedback and suggest next steps.
